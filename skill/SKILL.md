...
Если команда не найдена или версия ниже 20 — по-человечески сообщи пользователю,
что для скилла нужен Node.js ≥ 20, подскажи установку (nodejs.org, LTS-версия,
или менеджер версий вроде nvm/fnm) и ОСТАНОВИСЬ до установки. Команды скилла
раньше не запускай: без Node они выдадут лишь техническое `command not found`,
а не понятное сообщение.
