...
Превращает ИИ-агента в инвестиционного консультанта по вашему брокерскому счёту
Т-Инвестиций. Вы спрашиваете обычным
...
Токены выпускаются в [личном кабинете Т-Инвестиций](https://www.tbank.ru/invest/settings/)
→ «Токены T-Invest API» (уровень доступа под режим — по таблице выше; пошагово —
в [инструкции по выпуску токена](https://developer.tbank.ru/invest/intro/intro/token)).
