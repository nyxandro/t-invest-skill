...
и операции по вашей команде — через [T-Invest API](https://developer.tbank.ru/invest/api).
...
инвестиционных рекомендаций (см. [Дисклеймер](#дисклеймер)).
...
рекомендаций (ИИР)**. Данные и расчёты предоставляются «как есть», информационно;
